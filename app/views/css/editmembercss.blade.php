...
<div class="row">
             ...
             <div class="form-group">                        
                        ...
                        <td>{{$j}}</td><td>{{$document->path}}</td>
                        <td>
                        <a class="btn btn-danger delbtn" id="<?php echo $document->id; ?>">Delete</a>
                        </td>
                        </tr>
                        <?php $j++;?>
                        @endforeach
                        ...
                        <td></td>
                        <td></td>
                        <td colspan="2" align="center"><strong>Documents not found</strong></td>
                        </tr>
                        @endif
                    </tbody>
                        </table>
